...
#define OUT2 PB0 //Pin 5
#define ENA  PB4 //Pin 3

//inputs
#define INPUT PB3 //Pin 2
#define ISense PB2 //Pin 7

#define set_up_input() (PORTB |= (1 << INPUT)) //Pullup input
...
#define get_value() (ADCL + (ADCH << 8)) //10-bit value mapping VCC to GND. Val = Vin*1024/Vref
...
#define disable_timer0_interrupt() (TIMSK &= ~(1 << TOIE0))
#define reset_timer0() (TCNT0 = 0)
#define enable_timer0_interrupt() (TIMSK |= (1 << TOIE0))

//Prescaling 1/4, Enabled PWMB with clear on comapre match, Enable PLL
...
#define disable_timer1_interrupt() (TIMSK &= ~(1 << TOIE1))
#define reset_timer1() (TCNT1 = 0)
#define enable_timer1_interrupt() (TIMSK |= (1 << TOIE1))
